<template>
    <div class="hero" v-if="contents != undefined" ref="hero">
    ...
    methods: {
        getIndex() {
            const interval = setInterval(() => {
                ...
                if (this.number < 9 && this.$refs.hero) {
                    this.number++;
                    this.$refs.hero.scrollLeft += this.$refs.hero.scrollWidth / 10;
                } else if (this.$refs.hero) {
                    this.number = 0;
                    this.$refs.hero.scrollLeft -= this.$refs.hero.scrollWidth;
                }
            }, 2000);
            return interval;
        },
...
.hero {
    ...
    .layover {
        ...
        height: 100%;
        z-index: 1;
        background: linear-gradient(rgba(255,255,255,0) 60%, rgba(20,20,20,1) 99%);
    }
    .card {

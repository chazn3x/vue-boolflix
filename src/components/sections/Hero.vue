<template>
    <div class="hero">
        <div class="background-img">
            <img v-if="content.backdrop_path" :src="'https://image.tmdb.org/t/p/original/' + content.backdrop_path" alt="">
        </div>
        <div class="info">
...
export default {
    ...
    created() {
        ...
        .then(response => {
            this.content = response.data.results[1];
            console.log(this.content.backdrop_path);
        })
    }
}
</script>

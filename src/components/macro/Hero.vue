        ...
        <div class="hero">
            <div class="card">
                ...
                <div class="info">
                    ...
                    <div class="content-title" @click="openInfo(content)" :title="content.title || content.name">
                    ...
                    <div class="rank">
                        ...
                        <p>Oggi al n° {{index}} fra {{data.selected == data.pages[0] ? 'i' : data.selected == data.pages[1] ? 'le serie' : 'i film'}} più popolari</p>
                    </div>
                    <div class="overview">
                        <p>{{content.overview}}</p>
                    </div>
                    <div class="info-btn" @click="openInfo(content)" title="Mostra informazioni">
                        <div class="circle">
                            <span>i</span>
                        </div>
